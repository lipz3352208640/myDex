...
CREATE TABLE `market_kline_trade_process` (
  `id` bigint AUTO_INCREMENT,
  `hash_id` varchar(191) NOT NULL,
  `interval_val` varchar(16) NOT NULL,
  `pair_addr` varchar(128) NOT NULL,
  `tx_hash` varchar(191) NOT NULL,
  `block_time` bigint NOT NULL,
  `created_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_market_kline_process` (`hash_id`, `interval_val`)
);
...
CREATE TABLE  `market_kline` (
  ...
  `pair_addr` varchar(128) NOT NULL,
  `token_addr` varchar(128) NOT NULL,
  `interval_val` varchar(16) NOT NULL,
  ...
  `mcap_open` double NOT NULL,
  `mcap_high` double NOT NULL,
  `mcap_low` double NOT NULL,
  `mcap_close` double NOT NULL,
  `amount_usd` double NOT NULL,
  `volume_token` double NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_market_kline` (`chain_id`, `pair_addr`, `interval_val`, `candle_time`)
);
