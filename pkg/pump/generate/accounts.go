...
func (obj FeeConfigAccount) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Write account discriminator:
	err = encoder.WriteBytes(FeeConfigAccountDiscriminator[:], false)
	if err != nil {
		return err
	}
...
func (obj *FeeConfigAccount) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Read and check account discriminator:
	{
		discriminator, err := decoder.ReadTypeID()
		if err != nil {
...
type SharingConfigAccount struct {
	Bump         uint8
	Version      uint8
	Status       ConfigStatus
	Mint         ag_solanago.PublicKey
...
var SharingConfigAccountDiscriminator = [8]byte{216, 74, 9, 0, 56, 140, 93, 75}

func (obj SharingConfigAccount) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Write account discriminator:
	err = encoder.WriteBytes(SharingConfigAccountDiscriminator[:], false)
	if err != nil {
		return err
	}
	// Serialize `Bump` param:
...
func (obj *SharingConfigAccount) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Read and check account discriminator:
	{
		discriminator, err := decoder.ReadTypeID()
		if err != nil {
		...
		if !discriminator.Equal(SharingConfigAccountDiscriminator[:]) {
			return fmt.Errorf(
				"wrong discriminator: wanted %s, got %s",
