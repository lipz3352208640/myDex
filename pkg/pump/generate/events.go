...
type DistributeCreatorFeesEventEventData struct {
	Timestamp     int64
	Mint          ag_solanago.PublicKey
	BondingCurve  ag_solanago.PublicKey
...
var DistributeCreatorFeesEventEventDataDiscriminator = [8]byte{165, 55, 129, 112, 4, 179, 202, 40}

func (obj DistributeCreatorFeesEventEventData) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Write account discriminator:
	err = encoder.WriteBytes(DistributeCreatorFeesEventEventDataDiscriminator[:], false)
	if err != nil {
		return err
	}
	// Serialize `Timestamp` param:
	...
	// Serialize `Shareholders` param:
	err = encoder.Encode(obj.Shareholders)
	if err != nil {
		return err
	}
	// Serialize `Distributed` param:
...
func (obj *DistributeCreatorFeesEventEventData) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Read and check account discriminator:
	{
		discriminator, err := decoder.ReadTypeID()
		if err != nil {
		...
		if !discriminator.Equal(DistributeCreatorFeesEventEventDataDiscriminator[:]) {
			return fmt.Errorf(
				"wrong discriminator: wanted %s, got %s",
...
func (*DistributeCreatorFeesEventEventData) isEventData() {}
func (obj *DistributeCreatorFeesEventEventData) Self() any {
	return obj
}
...
type MigrateBondingCurveCreatorEventEventData struct {
	Timestamp     int64
	Mint          ag_solanago.PublicKey
	BondingCurve  ag_solanago.PublicKey
	SharingConfig ag_solanago.PublicKey
...
var MigrateBondingCurveCreatorEventEventDataDiscriminator = [8]byte{155, 167, 104, 220, 213, 108, 243, 3}

func (obj MigrateBondingCurveCreatorEventEventData) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Write account discriminator:
	err = encoder.WriteBytes(MigrateBondingCurveCreatorEventEventDataDiscriminator[:], false)
	if err != nil {
		return err
	}
	// Serialize `Timestamp` param:
...
func (obj *MigrateBondingCurveCreatorEventEventData) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Read and check account discriminator:
	{
		discriminator, err := decoder.ReadTypeID()
		if err != nil {
		...
		if !discriminator.Equal(MigrateBondingCurveCreatorEventEventDataDiscriminator[:]) {
			return fmt.Errorf(
				"wrong discriminator: wanted %s, got %s",
...
func (*MigrateBondingCurveCreatorEventEventData) isEventData() {}
func (obj *MigrateBondingCurveCreatorEventEventData) Self() any {
	return obj
}

type MinimumDistributableFeeEventEventData struct {
	MinimumRequired   uint64
	DistributableFees uint64
	CanDistribute     bool
}

var MinimumDistributableFeeEventEventDataDiscriminator = [8]byte{168, 216, 132, 239, 235, 182, 49, 52}

func (obj MinimumDistributableFeeEventEventData) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Write account discriminator:
	err = encoder.WriteBytes(MinimumDistributableFeeEventEventDataDiscriminator[:], false)
	if err != nil {
		return err
	}
	// Serialize `MinimumRequired` param:
	err = encoder.Encode(obj.MinimumRequired)
	if err != nil {
		return err
	}
	// Serialize `DistributableFees` param:
	err = encoder.Encode(obj.DistributableFees)
	if err != nil {
		return err
	}
	// Serialize `CanDistribute` param:
...
func (obj *MinimumDistributableFeeEventEventData) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Read and check account discriminator:
	{
		discriminator, err := decoder.ReadTypeID()
		if err != nil {
		...
		if !discriminator.Equal(MinimumDistributableFeeEventEventDataDiscriminator[:]) {
			return fmt.Errorf(
				"wrong discriminator: wanted %s, got %s",
...
func (*MinimumDistributableFeeEventEventData) isEventData() {}
func (obj *MinimumDistributableFeeEventEventData) Self() any {
	return obj
}
...
type UpdateMayhemVirtualParamsEventEventData struct {
	Timestamp               int64
	Mint                    ag_solanago.PublicKey
	VirtualTokenReserves    uint64
	VirtualSolReserves      uint64
...
var UpdateMayhemVirtualParamsEventEventDataDiscriminator = [8]byte{117, 123, 228, 182, 161, 168, 220, 214}

func (obj UpdateMayhemVirtualParamsEventEventData) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Write account discriminator:
	err = encoder.WriteBytes(UpdateMayhemVirtualParamsEventEventDataDiscriminator[:], false)
	if err != nil {
		return err
	}
	// Serialize `Timestamp` param:
	...
	// Serialize `NewVirtualTokenReserves` param:
	err = encoder.Encode(obj.NewVirtualTokenReserves)
	if err != nil {
		return err
	}
	// Serialize `NewVirtualSolReserves` param:
...
func (obj *UpdateMayhemVirtualParamsEventEventData) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Read and check account discriminator:
	{
		discriminator, err := decoder.ReadTypeID()
		if err != nil {
		...
		if !discriminator.Equal(UpdateMayhemVirtualParamsEventEventDataDiscriminator[:]) {
			return fmt.Errorf(
				"wrong discriminator: wanted %s, got %s",
...
func (*UpdateMayhemVirtualParamsEventEventData) isEventData() {}
func (obj *UpdateMayhemVirtualParamsEventEventData) Self() any {
	return obj
}
...
var eventTypes = map[[8]byte]reflect.Type{
	...
	DistributeCreatorFeesEventEventDataDiscriminator:      reflect.TypeOf(DistributeCreatorFeesEventEventData{}),
	...
	MigrateBondingCurveCreatorEventEventDataDiscriminator: reflect.TypeOf(MigrateBondingCurveCreatorEventEventData{}),
	MinimumDistributableFeeEventEventDataDiscriminator:    reflect.TypeOf(MinimumDistributableFeeEventEventData{}),
	...
	UpdateMayhemVirtualParamsEventEventDataDiscriminator:  reflect.TypeOf(UpdateMayhemVirtualParamsEventEventData{}),
}
var eventNames = map[[8]byte]string{
	...
	DistributeCreatorFeesEventEventDataDiscriminator:      "DistributeCreatorFeesEvent",
	...
	MigrateBondingCurveCreatorEventEventDataDiscriminator: "MigrateBondingCurveCreatorEvent",
	MinimumDistributableFeeEventEventDataDiscriminator:    "MinimumDistributableFeeEvent",
	...
	UpdateMayhemVirtualParamsEventEventDataDiscriminator:  "UpdateMayhemVirtualParamsEvent",
}
var (
	_ fmt.Formatter = nil
)
