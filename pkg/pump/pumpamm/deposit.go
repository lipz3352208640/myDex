...
func (inst *DepositInstruction) SetLpTokenAmountOut(lp_token_amount_out uint64) *DepositInstruction {
	inst.LpTokenAmountOut = &lp_token_amount_out
	return inst
}

// SetMaxBaseAmountIn sets the "max_base_amount_in" parameter.
func (inst *DepositInstruction) SetMaxBaseAmountIn(max_base_amount_in uint64) *DepositInstruction {
	inst.MaxBaseAmountIn = &max_base_amount_in
	return inst
}

// SetMaxQuoteAmountIn sets the "max_quote_amount_in" parameter.
func (inst *DepositInstruction) SetMaxQuoteAmountIn(max_quote_amount_in uint64) *DepositInstruction {
	inst.MaxQuoteAmountIn = &max_quote_amount_in
	return inst
}

// SetPoolAccount sets the "pool" account.
func (inst *DepositInstruction) SetPoolAccount(pool ag_solanago.PublicKey) *DepositInstruction {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(pool).WRITE()
	return inst
}

// GetPoolAccount gets the "pool" account.
func (inst *DepositInstruction) GetPoolAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetGlobalConfigAccount sets the "global_config" account.
func (inst *DepositInstruction) SetGlobalConfigAccount(globalConfig ag_solanago.PublicKey) *DepositInstruction {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(globalConfig)
	return inst
}

// GetGlobalConfigAccount gets the "global_config" account.
func (inst *DepositInstruction) GetGlobalConfigAccount() *ag_solanago.AccountMeta {
...
func (inst *DepositInstruction) SetBaseMintAccount(baseMint ag_solanago.PublicKey) *DepositInstruction {
	inst.AccountMetaSlice[3] = ag_solanago.Meta(baseMint)
	return inst
}

// GetBaseMintAccount gets the "base_mint" account.
func (inst *DepositInstruction) GetBaseMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetQuoteMintAccount sets the "quote_mint" account.
func (inst *DepositInstruction) SetQuoteMintAccount(quoteMint ag_solanago.PublicKey) *DepositInstruction {
	inst.AccountMetaSlice[4] = ag_solanago.Meta(quoteMint)
	return inst
}

// GetQuoteMintAccount gets the "quote_mint" account.
func (inst *DepositInstruction) GetQuoteMintAccount() *ag_solanago.AccountMeta {
...
func (inst *DepositInstruction) SetUserBaseTokenAccountAccount(userBaseTokenAccount ag_solanago.PublicKey) *DepositInstruction {
...
func (inst *DepositInstruction) GetUserBaseTokenAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(6)
}

// SetUserQuoteTokenAccountAccount sets the "user_quote_token_account" account.
func (inst *DepositInstruction) SetUserQuoteTokenAccountAccount(userQuoteTokenAccount ag_solanago.PublicKey) *DepositInstruction {
...
func (inst *DepositInstruction) GetUserQuoteTokenAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(7)
}

// SetUserPoolTokenAccountAccount sets the "user_pool_token_account" account.
func (inst *DepositInstruction) SetUserPoolTokenAccountAccount(userPoolTokenAccount ag_solanago.PublicKey) *DepositInstruction {
...
func (inst *DepositInstruction) GetUserPoolTokenAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(8)
}

// SetPoolBaseTokenAccountAccount sets the "pool_base_token_account" account.
func (inst *DepositInstruction) SetPoolBaseTokenAccountAccount(poolBaseTokenAccount ag_solanago.PublicKey) *DepositInstruction {
...
func (inst *DepositInstruction) GetPoolBaseTokenAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(9)
}

// SetPoolQuoteTokenAccountAccount sets the "pool_quote_token_account" account.
func (inst *DepositInstruction) SetPoolQuoteTokenAccountAccount(poolQuoteTokenAccount ag_solanago.PublicKey) *DepositInstruction {
...
func (inst *DepositInstruction) GetPoolQuoteTokenAccountAccount() *ag_solanago.AccountMeta {
...
func (inst *DepositInstruction) SetToken2022ProgramAccount(token2022Program ag_solanago.PublicKey) *DepositInstruction {
	inst.AccountMetaSlice[12] = ag_solanago.Meta(token2022Program)
	return inst
}

// GetToken2022ProgramAccount gets the "token_2022_program" account.
func (inst *DepositInstruction) GetToken2022ProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(12)
}

// SetEventAuthorityAccount sets the "event_authority" account.
func (inst *DepositInstruction) SetEventAuthorityAccount(eventAuthority ag_solanago.PublicKey) *DepositInstruction {
	inst.AccountMetaSlice[13] = ag_solanago.Meta(eventAuthority)
	return inst
}

func (inst *DepositInstruction) findFindEventAuthorityAddress(knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
...
func (inst *DepositInstruction) FindEventAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindEventAuthorityAddress(bumpSeed)
	return
}

func (inst *DepositInstruction) MustFindEventAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindEventAuthorityAddress(bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *DepositInstruction) FindEventAuthorityAddress() (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindEventAuthorityAddress(0)
	return
}

func (inst *DepositInstruction) MustFindEventAuthorityAddress() (pda ag_solanago.PublicKey) {
...
func (inst *DepositInstruction) GetEventAuthorityAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(13)
}

// SetProgramAccount sets the "program" account.
func (inst *DepositInstruction) SetProgramAccount(program ag_solanago.PublicKey) *DepositInstruction {
	inst.AccountMetaSlice[14] = ag_solanago.Meta(program)
	return inst
}

// GetProgramAccount gets the "program" account.
func (inst *DepositInstruction) GetProgramAccount() *ag_solanago.AccountMeta {
...
func NewDepositInstruction(
	...
	program ag_solanago.PublicKey) *DepositInstruction {
