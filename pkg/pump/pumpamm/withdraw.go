...
func (inst *WithdrawInstruction) SetLpTokenAmountIn(lp_token_amount_in uint64) *WithdrawInstruction {
	inst.LpTokenAmountIn = &lp_token_amount_in
	return inst
}

// SetMinBaseAmountOut sets the "min_base_amount_out" parameter.
func (inst *WithdrawInstruction) SetMinBaseAmountOut(min_base_amount_out uint64) *WithdrawInstruction {
	inst.MinBaseAmountOut = &min_base_amount_out
	return inst
}

// SetMinQuoteAmountOut sets the "min_quote_amount_out" parameter.
func (inst *WithdrawInstruction) SetMinQuoteAmountOut(min_quote_amount_out uint64) *WithdrawInstruction {
	inst.MinQuoteAmountOut = &min_quote_amount_out
	return inst
}

// SetPoolAccount sets the "pool" account.
func (inst *WithdrawInstruction) SetPoolAccount(pool ag_solanago.PublicKey) *WithdrawInstruction {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(pool).WRITE()
	return inst
}

// GetPoolAccount gets the "pool" account.
func (inst *WithdrawInstruction) GetPoolAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetGlobalConfigAccount sets the "global_config" account.
func (inst *WithdrawInstruction) SetGlobalConfigAccount(globalConfig ag_solanago.PublicKey) *WithdrawInstruction {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(globalConfig)
	return inst
}

// GetGlobalConfigAccount gets the "global_config" account.
func (inst *WithdrawInstruction) GetGlobalConfigAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetUserAccount sets the "user" account.
func (inst *WithdrawInstruction) SetUserAccount(user ag_solanago.PublicKey) *WithdrawInstruction {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(user).SIGNER()
	return inst
}

// GetUserAccount gets the "user" account.
func (inst *WithdrawInstruction) GetUserAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetBaseMintAccount sets the "base_mint" account.
func (inst *WithdrawInstruction) SetBaseMintAccount(baseMint ag_solanago.PublicKey) *WithdrawInstruction {
	inst.AccountMetaSlice[3] = ag_solanago.Meta(baseMint)
	return inst
}

// GetBaseMintAccount gets the "base_mint" account.
func (inst *WithdrawInstruction) GetBaseMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetQuoteMintAccount sets the "quote_mint" account.
func (inst *WithdrawInstruction) SetQuoteMintAccount(quoteMint ag_solanago.PublicKey) *WithdrawInstruction {
	inst.AccountMetaSlice[4] = ag_solanago.Meta(quoteMint)
	return inst
}

// GetQuoteMintAccount gets the "quote_mint" account.
func (inst *WithdrawInstruction) GetQuoteMintAccount() *ag_solanago.AccountMeta {
...
func (inst *WithdrawInstruction) SetUserBaseTokenAccountAccount(userBaseTokenAccount ag_solanago.PublicKey) *WithdrawInstruction {
...
func (inst *WithdrawInstruction) GetUserBaseTokenAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(6)
}

// SetUserQuoteTokenAccountAccount sets the "user_quote_token_account" account.
func (inst *WithdrawInstruction) SetUserQuoteTokenAccountAccount(userQuoteTokenAccount ag_solanago.PublicKey) *WithdrawInstruction {
...
func (inst *WithdrawInstruction) GetUserQuoteTokenAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(7)
}

// SetUserPoolTokenAccountAccount sets the "user_pool_token_account" account.
func (inst *WithdrawInstruction) SetUserPoolTokenAccountAccount(userPoolTokenAccount ag_solanago.PublicKey) *WithdrawInstruction {
...
func (inst *WithdrawInstruction) GetUserPoolTokenAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(8)
}

// SetPoolBaseTokenAccountAccount sets the "pool_base_token_account" account.
func (inst *WithdrawInstruction) SetPoolBaseTokenAccountAccount(poolBaseTokenAccount ag_solanago.PublicKey) *WithdrawInstruction {
...
func (inst *WithdrawInstruction) GetPoolBaseTokenAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(9)
}

// SetPoolQuoteTokenAccountAccount sets the "pool_quote_token_account" account.
func (inst *WithdrawInstruction) SetPoolQuoteTokenAccountAccount(poolQuoteTokenAccount ag_solanago.PublicKey) *WithdrawInstruction {
...
func (inst *WithdrawInstruction) GetPoolQuoteTokenAccountAccount() *ag_solanago.AccountMeta {
...
func (inst *WithdrawInstruction) SetToken2022ProgramAccount(token2022Program ag_solanago.PublicKey) *WithdrawInstruction {
	inst.AccountMetaSlice[12] = ag_solanago.Meta(token2022Program)
	return inst
}

// GetToken2022ProgramAccount gets the "token_2022_program" account.
func (inst *WithdrawInstruction) GetToken2022ProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(12)
}

// SetEventAuthorityAccount sets the "event_authority" account.
func (inst *WithdrawInstruction) SetEventAuthorityAccount(eventAuthority ag_solanago.PublicKey) *WithdrawInstruction {
	inst.AccountMetaSlice[13] = ag_solanago.Meta(eventAuthority)
	return inst
}

func (inst *WithdrawInstruction) findFindEventAuthorityAddress(knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
...
func (inst *WithdrawInstruction) FindEventAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindEventAuthorityAddress(bumpSeed)
	return
}

func (inst *WithdrawInstruction) MustFindEventAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindEventAuthorityAddress(bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *WithdrawInstruction) FindEventAuthorityAddress() (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindEventAuthorityAddress(0)
	return
}

func (inst *WithdrawInstruction) MustFindEventAuthorityAddress() (pda ag_solanago.PublicKey) {
...
func (inst *WithdrawInstruction) GetEventAuthorityAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(13)
}

// SetProgramAccount sets the "program" account.
func (inst *WithdrawInstruction) SetProgramAccount(program ag_solanago.PublicKey) *WithdrawInstruction {
	inst.AccountMetaSlice[14] = ag_solanago.Meta(program)
	return inst
}

// GetProgramAccount gets the "program" account.
func (inst *WithdrawInstruction) GetProgramAccount() *ag_solanago.AccountMeta {
...
func NewWithdrawInstruction(
	...
	program ag_solanago.PublicKey) *WithdrawInstruction {
